 ...
 *  - `query(":self")` : Include the current element into the animation sequence.
    ...
    /**
     * Retrieves an implementation of Zoom animation on open-close state changes.
     * @param selector Trigger name on the animated parent element.
     * @param config Animation configuration defined by [`ZoomConfig`](./animations-config.d.ts).
     * Use it to customize the animation.
     * @returns Animation Trigger ready to be declared on an Angular Component.
     * 
     * @usageNotes
     ...
     *   templateUrl: "my-component-tpl.html",
     *   animations: [
     *     LgfTriggers.openClosedZoom('myAnimationTrigger', {timings:'200ms'})
     *   ]
     * })
     * class MyComponent {
     *   myTriggerExpression = "something";
     ...
     * This is most useful to create toggle effects.
     */
    export function openClosedZoom(
        selector: string
        ...
        const zoom = new Zoom(config);
        return OpenClosedTriggers.zoomTrigger(selector, zoom);
    }
    /**
     * Retrieves an implementation of Y-axis Collapse and Zoom animation on open-close state changes.
     * @param selector Trigger name on the animated parent element.
     * @param config Animation configuration defined by [`YCollapseAndZoom`](./animations-config.d.ts).
     * Use it to customize the animation.
     * @returns Animation Trigger ready to be declared on an Angular Component.
     * 
     * @usageNotes
     ...
     *   templateUrl: "my-component-tpl.html",
     *   animations: [
     *     LgfTriggers.openClosedYCollapseAndZoom('myAnimationTrigger', {timings:'200ms'})
     *   ]
     * })
     * class MyComponent {
     *   myTriggerExpression = "something";
     ...
     * This is most useful to create toggle effects.
     */
    export function openClosedYCollapseAndZoom(
        selector: string
        , config: AnimationsConfigs.YCollapseAndZoom = {
            startScale: Defaults.START_SCALE
            , endScale: Defaults.END_SCALE
            , startHeight: Defaults.START_HEIGHT
            , endHeight: Defaults.END_HEIGHT
